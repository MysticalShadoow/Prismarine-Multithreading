...
// }
// function botCanHit(elTarget: Entity) {
//     var returner = dist3d(
...
//             bot.entity.position.z,
//             elTarget.position.x,
//             elTarget.position.y + elTarget.height,
//             elTarget.position.z
//         )
//     ) {
//         returner = dist3d(
...
// let jumpTarget: Vec3 | undefined;
// var jumpTargets: any[] = [];
// var botPvpRandoms = {
//     aggroAmount: 0.25,
//     aggroChangeHits: 10,
// };
// function attackEntity(bot: Bot, target: Entity) {
//     (bot.attack as any)(target, true);
//     attackTimer = 0;
// }
// var botPvpRandomsDamages: { [aggroNum: string]: number } = {
//     "0.15": 0,
//     "0.25": 0,
//     "0.3": 0,
//     "0.35": 0,
...
//             JSON.stringify(target.username) != '"Vakore2"' &&
//             (attackTimer < botPvpRandoms.aggroAmount) || (botCanHit(target) <= botRange)
//         ) {
//             strafeTimer--;
...
// };
// let myStates: any[] = [];
// function simulateJump(stateBase: typeof PlayerState, searchCount: number, theParent?: any) {
//     //bot.chat("/particle minecraft:flame ~ ~ ~");
//     //bot.entity.yaw
//     let target = bot.nearestEntity();
//     if (!target) return
//     // bot.lookAt(new Vec3(target.position.x, bot.entity.position.y + 1.6, target.position.z), 360);
//     bot.lookAt(new Vec3(target.position.x, bot.entity.position.y + 1.6, target.position.z), true);
//     var myStateBase = stateBase;
//     var myDelta = new Vec3(
//         target.position.x - myStateBase.pos.x,
//         target.position.y - myStateBase.pos.y,
//         target.position.z - myStateBase.pos.z
//     );
...
//         myState.yaw = j;
//         for (var i = 0; i < 30; i++) {
//             (bot.physics as any).simulatePlayer(myState, bot.world); //patch later
//             if (myState.onGround | myState.isInWater | myState.isInLava) break
...
//             if (
//                 myStates[i].open == true &&
//                 dist3d(
//                     myStates[i].state.pos.x,
//                     myStates[i].state.pos.y,
//                     myStates[i].state.pos.z,
//                     target.position.x,
//                     target.position.y,
//                     target.position.z
//                 ) <
//                     dist3d(
//                         myStates[myBestState].state.pos.x,
//                         myStates[myBestState].state.pos.y,
//                         myStates[myBestState].state.pos.z,
//                         target.position.x,
//                         target.position.y,
//                         target.position.z
//                     )
...
//             bot.lookAt(new Vec3(mySearcher.state.pos.x, /*mySearcher.state.pos.y*/ target.position.y + 1.6, mySearcher.state.pos.z), true);
...
//             break;
//         case "inventory":
//             equipItem(bot, [msg[1]], msg[2] as EquipmentDestination);
//             break;
//         case "walk":
//             bot.setControlState("forward", true);
//             break;
...
//                 mySimCount = parseInt(message[1]);
//                 console.log("mySimCount is " + message[1]);
//             }
...
//             bot.lookAt(new Vec3(jumpTarget.x, /*jumpTarget.y*/ target.position.y + 1.6, jumpTarget.z), true);
//         }
//     }
// });
...
// const shieldListener = (packet: any) => {
...
//         console.log("error no entity with such packet id");
//         return;
//     }
...
//             //equipItem(bot, ["diamond_axe","iron_axe","stone_axe","golden_axe","wooden_axe"]);
//         } else {
//             //2 is unequip shield but if the player swaps to a different animation(bow) it won't send
//             //equipItem(bot, ["diamond_sword","iron_sword","stone_sword","golden_sword","wooden_sword"]);
