...
class EntityTracker {
    constructor(bot) {
        ...
        this.test = (packet) => {
            ...
            if (!speed.equals(this.trackingData[entityId].info.avgSpeed))
        ...
        this.hawkeyeRewriteTracking = () => {
            ...
            for (const entityId in this.trackingData) {
                ...
                if (this.trackingData[entityId].info.tickInfo.length > 0) {
                    const shiftPos = currentPos.minus(this.trackingData[entityId].info.tickInfo[this.trackingData[entityId].info.tickInfo.length - 1].position);
