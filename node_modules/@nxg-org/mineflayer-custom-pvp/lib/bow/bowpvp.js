...
class BowPVP {
    ...
    shotToEntity(entity, velocity) {
        if (!velocity)
            velocity = this.bot.tracker.getEntitySpeed(entity) || new vec3_1.Vec3(0, 0, 0);
     ...
     * @returns
     */
    hasWeapon(weapon = this.weapon, requiresAmmo = true) {
        const foundWeapon = this.bot.util.inv.getAllItems().find((item) => weapon && item.name.includes(weapon));
        if (!foundWeapon)
            return false;
        if (requiresAmmo)
            return this.hasAmmo(foundWeapon.name);
        return true;
    }
    /**
     * @function hasAmmo
     ...
     *  ```
     */
    equipWeapon(weapon = this.weapon) {
    ...
    attack(target, weapon) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (weapon === "crossbow_firework") {
                ...
                const hasWeapon = yield this.equipWeapon(weapon);
                if (!hasWeapon)
                    return this.stop();
            }
            if (weapon)
